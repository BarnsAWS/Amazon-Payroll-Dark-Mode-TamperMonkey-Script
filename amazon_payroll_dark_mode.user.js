// ==UserScript==
// @name         Amazon Payroll Dark Mode
// @namespace    http://tampermonkey.net/
// @version      1.3
// @description  High-contrast dark mode for payroll.amazon.work — nuclear approach.
//               Color palette: AWS Cloudscape "Polaris Dark Mode" tokens v3.3.
// @author       BarnsAWS
// @match        https://payroll.amazon.work/*
// @match        https://*.payroll.amazon.work/*
// @grant        GM_addStyle
...
(function() {
    ...
    const SCRIPT_NAME = 'Amazon Payroll Dark Mode';
    const STYLE_ID = 'amazon-payroll-dark-mode-style';
